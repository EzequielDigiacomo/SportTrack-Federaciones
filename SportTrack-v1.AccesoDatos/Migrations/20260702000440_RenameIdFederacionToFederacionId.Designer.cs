...
namespace SportTrack_v1.AccesoDatos.Migrations
{
    ...
    [Migration("20260702000440_RenameIdFederacionToFederacionId")]
    partial class RenameIdFederacionToFederacionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.AtletaFederado", b =>
                {
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.AtletaTutor", b =>
                {
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.DelegadoClub", b =>
                {
                    b.Property<int?>("IdParticipante")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.DocumentacionPersona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Entrenador", b =>
                {
                    b.Property<int>("IdParticipante")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Federacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Inscripcion", b =>
                {
                    ...
                    b.Property<int?>("AtletaFederadoIdParticipante")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AtletaFederadoIdParticipante");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.PagoTransaccion", b =>
                {
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Rol", b =>
                {
                    b.Property<int>("IdRol")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Tutor", b =>
                {
                    b.Property<int>("IdParticipante")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.AtletaFederado", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Federacion", "Federacion")
                    ...
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Participante", "Participante")
                        .WithOne("AtletaFederado")
                        .HasForeignKey("SportTrack_v1.Entidades.Entidades.AtletaFederado", "IdParticipante")
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.AtletaTutor", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.AtletaFederado", "AtletaFederado")
                        .WithMany("Tutores")
                        .HasForeignKey("IdAtleta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportTrack_v1.Entidades.Entidades.Tutor", "Tutor")
                        .WithMany("AtletasTutores")
                        .HasForeignKey("IdTutor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AtletaFederado");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.DelegadoClub", b =>
                {
                    ...
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Participante", "Participante")
                        ...
                        .HasForeignKey("SportTrack_v1.Entidades.Entidades.DelegadoClub", "IdParticipante")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportTrack_v1.Entidades.Entidades.Rol", "Rol")
                        .WithMany("DelegadosClub")
                        .HasForeignKey("IdRol")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Entrenador", b =>
                {
                    ...
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Participante", "Participante")
                        .WithOne("Entrenador")
                        .HasForeignKey("SportTrack_v1.Entidades.Entidades.Entrenador", "IdParticipante")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Inscripcion", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.AtletaFederado", null)
                        .WithMany("Inscripciones")
                        .HasForeignKey("AtletaFederadoIdParticipante");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Tutor", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Participante", "Participante")
                        .WithOne("Tutor")
                        .HasForeignKey("SportTrack_v1.Entidades.Entidades.Tutor", "IdParticipante")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
